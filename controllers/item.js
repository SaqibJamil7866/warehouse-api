    ...
    exports.getItems = asyncHandler(async (req, res) => {
      ...
      const grandSubClasses = [{key:'bv_beverage', value:'BV-beverage', parent:"food_beverage"}, 
        {key:'fo_food', value:'FO-FOOD', parent:"food_beverage"},{key:'fr_frozen', value:'FR-FROZEN', parent:"food_beverage"},
        ...
        {key:'mck_ceramic', value:'MCK-Ceramic', parent:"maintenance"},{key:'mdl_dubai_light', value:'MDL-Dubai Light', parent:"maintenance"},
        {key:'mec_electronics', value:'MEC-Electronics', parent:"maintenance"},{key:'mel_electricity', value:'MEL-Electricity', parent:"maintenance"},
        {key:'mgm_general', value:'MGM-General Maintenance', parent:"maintenance"},{key:'mme_mechanic', value:'MME-MECHANIC', parent:"maintenance"},
        {key:'mpd_pad', value:'MPD-Pad', parent:"maintenance"},{key:'mpe_paint', value:'MPE-Paint', parent:"maintenance"},
        ...
        {key:'ms_medical', value:'MS-Medical Supplies', parent:"medical_supplies"},{key:'os_orthopedic', value:'OS-Orthopedic Supplies', parent:"medical_supplies"},
        {key:'pathology', value:'Pathology supplies', parent:"medical_supplies"},

        {key:'me_medicines', value:'ME-Medicines', parent:"medicine"},

        {key:'of_office', value:'OF-Office Supplies', parent:"office_stationary_supplies"},{key:'st_stationary', value:'ST-Stationary Supplies', parent:"office_stationary_supplies"},
      
        {key:'cm_contrast', value:'CM-Contrast Media Supplies', parent:"radiology_medicine"},{key:'mri_contrast', value:'MRI Contrast Media', parent:"radiology_medicine"},
